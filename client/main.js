...
$(document).ready(function(){
    ...
    $.ajax({
        type: 'GET',
          url: '/server/tutorial_authentication_master_function/todo', //Ensure that 'to_do_list_function' is the package name of your function
          async: false,
    ...
    $(document).on("click","#to-do-list-div ul li",function()
    {
		...
		$.ajax({
		  type: 'DELETE',
		  url: '/server/tutorial_authentication_master_function/todo' + itemRowId, //Appends the ROWID along with the URL 
